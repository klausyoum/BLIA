...
public class DbUtil {
	...
	public int createAllAnalysisTables() throws Exception {
		String sql = "CREATE TABLE SF_INFO(SF_ID INT PRIMARY KEY HASH AUTO_INCREMENT, SF_NAME VARCHAR(255), CLS_NAME VARCHAR(255)); " +
				...
				"CREATE TABLE SF_TERM_INFO (SF_TERM_ID INT PRIMARY KEY HASH AUTO_INCREMENT, TERM VARCHAR(255)); " + 
				...
				"CREATE TABLE MTH_INFO(MTH_ID INT PRIMARY KEY HASH AUTO_INCREMENT, SF_VER_ID INT, MTH_NAME VARCHAR(127), RET_TYPE VARCHAR(63), PARAMS VARCHAR(255), HASH_KEY VARCHAR(40)); " +
				...
				"CREATE TABLE BUG_INFO(BUG_ID INT PRIMARY KEY HASH, OPEN_DATE DATETIME, FIXED_DATE DATETIME,"
				...
				"CREATE TABLE BUG_CMT_INFO(BUG_ID INT, CMT_ID INT, ATHR VARCHAR(31), CMT_COR VARCHAR); " +
				"CREATE INDEX IDX_BUG_CMT_INFO ON BUG_CMT_INFO(BUG_ID); " +

				"CREATE TABLE BUG_TERM_INFO(BUG_TERM_ID INT PRIMARY KEY HASH AUTO_INCREMENT, TERM VARCHAR(255)); " +
				...
				"CREATE TABLE BUG_FIX_SF_INFO(BUG_ID INT, FIXED_SF_VER_ID INT); " +
				"CREATE INDEX IDX_BUG_FIX_SF_INFO ON BUG_FIX_SF_INFO(BUG_ID); " +

				"CREATE TABLE BUG_FIX_MTH_INFO(BUG_ID INT, FIXED_MTH_ID INT); " +
				...
				"CREATE TABLE COMM_INFO(COMM_ID VARCHAR(127) PRIMARY KEY HASH, COMM_DATE DATETIME, MSG VARCHAR, COMMITTER VARCHAR(63)); " +
				...
				"CREATE TABLE COMM_MTH_INFO(COMM_ID VARCHAR(127), COMM_FILE VARCHAR(255), COMM_MTH VARCHAR(255), COM_MTH_HASH_KEY VARCHAR(40)); " +
				...
				"CREATE MEMORY TABLE INT_MTH_ANALYSIS(BUG_ID INT, MTH_ID INT, COMM_SCORE DOUBLE, BLIA_MTH_SCORE DOUBLE); " +
	...
	public void initializeAllData(boolean commitDataIncluded) throws Exception {
		...
		// TODO: Call CommitDAO, IntegratedAnalysisDAO
	}
