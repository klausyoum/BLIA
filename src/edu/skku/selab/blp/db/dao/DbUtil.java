...
public class DbUtil {
	...
	public int createAllAnalysisTables() throws Exception {
		String sql = "CREATE TABLE SF_INFO(SF_ID INT PRIMARY KEY HASH AUTO_INCREMENT, SF_NAME VARCHAR(255), CLS_NAME VARCHAR(255)); " +
				...
				"CREATE TABLE BUG_CMT_INFO(BUG_ID INT, CMT_ID INT, ATHR VARCHAR(31), CMT_DATE DATETIME, CMT_COR VARCHAR); " +
				...
				"CREATE TABLE COMM_SF_INFO(COMM_ID VARCHAR(127), COMM_SF VARCHAR(255), COMM_TYPE INT); " +
				"CREATE INDEX IDX_COMM_SF_INFO ON COMM_SF_INFO(COMM_ID); " +
				
				"CREATE TABLE COMM_MTH_INFO(COMM_ID VARCHAR(127), COMM_SF VARCHAR(255), COMM_MTH VARCHAR(255), COM_MTH_HASH_KEY VARCHAR(40)); " +
